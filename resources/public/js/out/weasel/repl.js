...
weasel.repl.process_message = (function (){var method_table__25660__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"weasel.repl","process-message"),new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"default","default",-1987822328),hierarchy__25664__auto__,method_table__25660__auto__,prefer_table__25661__auto__,method_cache__25662__auto__,cached_hierarchy__25663__auto__));
})();
}
...
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(argseq__25805__auto__);
});
...
weasel.repl.repl_print.cljs$lang$applyTo = (function (seq32163){
return weasel.repl.repl_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32163));
});
weasel.repl.console_print = (function weasel$repl$console_print(){
var argseq__25805__auto__ = ((((0) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(0)),(0))):null);
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(argseq__25805__auto__);
});
...
weasel.repl.console_print.cljs$lang$applyTo = (function (seq32164){
return weasel.repl.console_print.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32164));
});
...
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__25805__auto__);
});

weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic = (function (repl_server_url,p__32170){
...
var verbose = cljs.core.get.call(null,map__32171__$1,new cljs.core.Keyword(null,"verbose","verbose",1694226060),true);
var on_open = cljs.core.get.call(null,map__32171__$1,new cljs.core.Keyword(null,"on-open","on-open",-1391088163));
var on_error = cljs.core.get.call(null,map__32171__$1,new cljs.core.Keyword(null,"on-error","on-error",1728533530));
var on_close = cljs.core.get.call(null,map__32171__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var print = cljs.core.get.call(null,map__32171__$1,new cljs.core.Keyword(null,"print","print",1299562414),new cljs.core.Keyword(null,"repl","repl",-35398667));
var repl_connection = weasel.impls.websocket.websocket_connection.call(null);
cljs.core.swap_BANG_.call(null,weasel.repl.ws_connection,cljs.core.constantly.call(null,repl_connection));

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"opened","opened",-1451743091),((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
});})(repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"message","message",-406056002),((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
var map__32172 = cljs.reader.read_string.call(null,evt.message);
...
var message = map__32172__$1;
var op = cljs.core.get.call(null,map__32172__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
var response = cljs.core.pr_str.call(null,weasel.repl.process_message.call(null,message));
return clojure.browser.net.transmit.call(null,repl_connection,response);
});})(repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print))
);

clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"closed","closed",-919675359),((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
...
clojure.browser.event.listen.call(null,repl_connection,new cljs.core.Keyword(null,"error","error",-978969032),((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (evt){
if(cljs.core.truth_(verbose)){
...
return cljs.core.into.call(null,cljs.core.PersistentHashSet.EMPTY,cljs.core.filter.call(null,((function (gntp,repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (name){
return (goog.dependencies_.visited[(gntp[name])]);
});})(gntp,repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print))
,cljs.core.js_keys.call(null,gntp)));
})();

goog.isProvided_ = ((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
return (function (_){
return false;
});})(repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print))
;

goog.require = ((function (repl_connection,map__32171,map__32171__$1,verbose,on_open,on_error,on_close,print){
...
weasel.repl.connect.cljs$lang$applyTo = (function (seq32168){
var G__32169 = cljs.core.first.call(null,seq32168);
var seq32168__$1 = cljs.core.next.call(null,seq32168);
return weasel.repl.connect.cljs$core$IFn$_invoke$arity$variadic(G__32169,seq32168__$1);
});
